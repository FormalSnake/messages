...
import { chatTitle, conversationHandles, copyText, formatAddress, handleName, matchFriend, openExternal, type Chat, type Handle, contactAddresses } from '@messages/core'
